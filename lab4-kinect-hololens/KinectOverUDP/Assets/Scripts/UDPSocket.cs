...
public class UDPSocket : MonoBehaviour
{
    ...
    /// Tag for logging
    /// </summary>
    static private string ModuleName = "UDPSocket";
    static private int InstanceCount = 0;

    // Object members
    [Tooltip("Instance name (shows on logs)")]
    ...
    /// <summary>
    /// IP address of IP that should receive the message 
    /// </summary>
    [Tooltip("IP that this socket will be sending messages")]
    public string destIP = "192.168.0.10";

    /// <summary>
    /// Port number of node that should receive the message
    /// </summary>
    [Tooltip("Port that this socket will be sending messages")]
    public int destPort = 50005;
